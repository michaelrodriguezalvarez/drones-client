...
@Injectable()
export class DroneServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    register(body: DroneDto | undefined): Observable<boolean> {
        let url_ = this.baseUrl + "/api/services/app/Drone/Register";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    load(body: LoadDronesRequestDto | undefined): Observable<boolean> {
        let url_ = this.baseUrl + "/api/services/app/Drone/Load";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processLoad(response: HttpResponseBase): Observable<boolean> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    checkLoaded(body: CheckDronesRequestDto | undefined): Observable<MedicationDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Drone/CheckLoaded";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCheckLoaded(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCheckLoaded(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<MedicationDtoPagedResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<MedicationDtoPagedResultDto>;
        }));
    }

    protected processCheckLoaded(response: HttpResponseBase): Observable<MedicationDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = MedicationDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
    ...
    checkAvailables(body: CheckAvailablesRequestDto | undefined): Observable<DroneDtoPagedResultDto> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCheckAvailables(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCheckAvailables(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<DroneDtoPagedResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<DroneDtoPagedResultDto>;
        }));
    }

    protected processCheckAvailables(response: HttpResponseBase): Observable<DroneDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = DroneDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Success
     */
    checkBatteryLevel(body: CheckDronesRequestDto | undefined): Observable<number> {
        let url_ = this.baseUrl + "/api/services/app/Drone/CheckBatteryLevel";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCheckBatteryLevel(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCheckBatteryLevel(response_ as any);
                } catch (e) {
    ...
    protected processCheckBatteryLevel(response: HttpResponseBase): Observable<number> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    unload(body: UnloadDroneDto | undefined): Observable<boolean> {
        let url_ = this.baseUrl + "/api/services/app/Drone/Unload";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUnload(response: HttpResponseBase): Observable<boolean> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    checkDronesBatteryLevelsActivate(active: boolean | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Drone/CheckDronesBatteryLevelsActivate?";
        if (active === null)
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCheckDronesBatteryLevelsActivate(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCheckDronesBatteryLevelsActivate(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processCheckDronesBatteryLevelsActivate(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    checkDronesBatteryLevels(): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Drone/CheckDronesBatteryLevels";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCheckDronesBatteryLevels(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCheckDronesBatteryLevels(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processCheckDronesBatteryLevels(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    get(id: number | undefined): Observable<DroneDto> {
        let url_ = this.baseUrl + "/api/services/app/Drone/Get?";
        if (id === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<DroneDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<DroneDto>;
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<DroneDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = DroneDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Success
     */
    getAll(keyword: string | undefined, sorting: string | undefined, descending: boolean | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<DroneDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Drone/GetAll?";
        if (keyword === null)
    ...
    protected processGetAll(response: HttpResponseBase): Observable<DroneDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    update(body: DroneDto | undefined): Observable<DroneDto> {
        let url_ = this.baseUrl + "/api/services/app/Drone/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<DroneDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Drone/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
...
export class MedicationServiceProxy {
     ...
     * @return Success
     */
    get(id: number | undefined): Observable<MedicationDto> {
        let url_ = this.baseUrl + "/api/services/app/Medication/Get?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<MedicationDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<MedicationDto>;
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<MedicationDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    getAll(keyword: string | undefined, sorting: string | undefined, descending: boolean | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<MedicationDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Medication/GetAll?";
        if (keyword === null)
            throw new Error("The parameter 'keyword' cannot be null.");
        else if (keyword !== undefined)
            url_ += "Keyword=" + encodeURIComponent("" + keyword) + "&";
    ...
    protected processGetAll(response: HttpResponseBase): Observable<MedicationDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    create(body: MedicationDto | undefined): Observable<MedicationDto> {
        let url_ = this.baseUrl + "/api/services/app/Medication/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate(response: HttpResponseBase): Observable<MedicationDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    update(body: MedicationDto | undefined): Observable<MedicationDto> {
        let url_ = this.baseUrl + "/api/services/app/Medication/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<MedicationDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     */
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Medication/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
...
export class CheckDronesRequestDto implements ICheckDronesRequestDto {
    ...
    constructor(data?: ICheckDronesRequestDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CheckDronesRequestDto {
        data = typeof data === 'object' ? data : {};
        let result = new CheckDronesRequestDto();
        result.init(data);
        return result;
    }
...
export interface ICheckDronesRequestDto {
    maxResultCount: number;
    skipCount: number;
    droneId: number;
    keyword: string | undefined;
...
export class DroneDtoPagedResultDto implements IDroneDtoPagedResultDto {
    items: DroneDto[] | undefined;
    totalCount: number;

    constructor(data?: IDroneDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            if (Array.isArray(_data["items"])) {
                ...
                for (let item of _data["items"])
                    this.items.push(DroneDto.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): DroneDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new DroneDtoPagedResultDto();
        result.init(data);
        return result;
    }
...
export interface IDroneDtoPagedResultDto {
    items: DroneDto[] | undefined;
    totalCount: number;
}
...
export class LoadDronesRequestDto implements ILoadDronesRequestDto {
    droneId: number;
    medicationItems: number[] | undefined;

    constructor(data?: ILoadDronesRequestDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.droneId = _data["droneId"];
            if (Array.isArray(_data["medicationItems"])) {
                this.medicationItems = [] as any;
                for (let item of _data["medicationItems"])
                    this.medicationItems.push(item);
            }
        }
    }

    static fromJS(data: any): LoadDronesRequestDto {
        data = typeof data === 'object' ? data : {};
        let result = new LoadDronesRequestDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["droneId"] = this.droneId;
        if (Array.isArray(this.medicationItems)) {
            data["medicationItems"] = [];
            for (let item of this.medicationItems)
                data["medicationItems"].push(item);
        }
        return data;
    }

    clone(): LoadDronesRequestDto {
        const json = this.toJSON();
        let result = new LoadDronesRequestDto();
        result.init(json);
        return result;
...
export interface ILoadDronesRequestDto {
    droneId: number;
    medicationItems: number[] | undefined;
}
...
export class MedicationDtoPagedResultDto implements IMedicationDtoPagedResultDto {
    items: MedicationDto[] | undefined;
    totalCount: number;

    constructor(data?: IMedicationDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items.push(MedicationDto.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): MedicationDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new MedicationDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): MedicationDtoPagedResultDto {
        const json = this.toJSON();
        let result = new MedicationDtoPagedResultDto();
        result.init(json);
        return result;
...
export interface IMedicationDtoPagedResultDto {
    items: MedicationDto[] | undefined;
    totalCount: number;
}
...
export class UnloadDroneDto implements IUnloadDroneDto {
    medicationId: number;
    droneId: number;

    constructor(data?: IUnloadDroneDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UnloadDroneDto {
        data = typeof data === 'object' ? data : {};
        let result = new UnloadDroneDto();
        result.init(data);
        return result;
    }
...
export interface IUnloadDroneDto {
    medicationId: number;
    droneId: number;
}
